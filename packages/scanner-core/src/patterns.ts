...
export const PATTERNS: Pattern[] = [
  ...
  {
    id: "aws-secret-by-name",
    name: "Likely AWS Secret Access Key (by name)",
    provider: "AWS",
    severity: "critical",
    runbookId: "aws",
  ...
  {
    id: "supabase-service",
    name: "Supabase Service Role Key (by name)",
    provider: "Supabase",
    severity: "critical",
    runbookId: "supabase",
  ...
  {
    id: "jwt-secret-name",
    name: "JWT Signing Secret (by name)",
    provider: "Generic",
    severity: "high",
    runbookId: "jwt",
  ...
  {
    id: "twilio-auth",
    name: "Twilio Auth Token (by name)",
    provider: "Twilio",
    severity: "high",
    runbookId: "twilio",
  ...
  },
  {
    ...
    name: "Variable named like a secret",
    provider: "Generic",
    severity: "medium",
