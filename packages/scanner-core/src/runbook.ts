...
export const RUNBOOK: Record<string, RunbookEntry> = {
  ...
  github: {
    ...
    postRotationNote:
      "Redeploy Vercel projects; re-run CI workflows using these tokens.",
  },
  npm: {
    id: "npm",
    ...
    postRotationNote:
      "If you publish packages, verify no unexpected versions were published.",
  },
  stripe: {
    id: "stripe",
  ...
  azure: {
    ...
    postRotationNote:
      "Storage key rotation is instant; service principal secrets support overlap.",
  },
  database: {
    id: "database",
    ...
    consoleUrl: "",
    postRotationNote:
      "Consider mTLS or IAM-based auth over long-lived passwords.",
  },
  supabase: {
    id: "supabase",
    ...
    postRotationNote:
      "Active sessions are logged out when the JWT secret rotates.",
  },
  clerk: {
    id: "clerk",
  ...
  mailgun: {
    ...
    steps: [
      "app.mailgun.com → API keys.",
      "Rotate the affected key.",
      "Update Vercel env vars, redeploy.",
    ],
    consoleUrl: "https://app.mailgun.com/app/account/security/api_keys",
    postRotationNote: "",
  },
  resend: {
    id: "resend",
    ...
    steps: [
      "resend.com/api-keys.",
      "Revoke exposed key; create replacement.",
      "Update Vercel env vars, redeploy.",
    ],
  ...
  gitlab: {
    id: "gitlab",
    title: "Rotate GitLab PAT",
    steps: [
      "gitlab.com → Avatar → Preferences → Access Tokens.",
      "Revoke exposed token; create replacement.",
      "Update Vercel and CI vars.",
    ],
  ...
  "generic-key": {
    ...
    consoleUrl: "",
    postRotationNote: "Depends on the service — follow its key rotation docs.",
  },
  "generic-unknown": {
    id: "generic-unknown",
    ...
    consoleUrl: "",
    postRotationNote:
      "If you can't identify it, remove the var and see what breaks in preview.",
  },
};
